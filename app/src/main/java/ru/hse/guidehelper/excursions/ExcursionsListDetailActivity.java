...
/**
 * An activity representing a single ExcursionsList detail screen. This
 * activity is only used on narrow width devices. On tablet-size devices,
 * item details are presented side-by-side with a list of items
 * in a {@link ExcursionsListListActivity}.
 */
public class ExcursionsListDetailActivity extends AppCompatActivity {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == android.R.id.home) {
            ...
            //
            navigateUpTo(new Intent(this, ExcursionsListListActivity.class));
            return true;
        }
